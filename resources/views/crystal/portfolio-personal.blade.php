            ...
            <div class="row">
                <div class="col-md-3 text-center">
                    <div class="single_service wow fadeInUp" data-wow-delay="1s">
                        ...
                        <h2>UX Design</h2>
                        <p>I design user experiance for more user friendly applications.</p>
                    </div>
                </div>
                <div class="col-md-3 text-center">
                    <div class="single_service wow fadeInUp" data-wow-delay="2s">
                        ...
                        <h2>Development</h2>
                        <p>I follow development process of a system/ application which takes less time to create dynamic systems with scalable features.</p>
                    </div>
                </div>
                <div class="col-md-3 text-center">
                ...
                <div class="col-md-3 text-center">
                    <div class="single_service wow fadeInUp" data-wow-delay="4s">
                        <i class="icon-chat"></i>
                        <h2>Consultancy</h2>
                        <p>I consult IT solutions to business owners and also developers following new technologies.</p>
                    </div>
                </div>
            </div>            
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4  wow fadeInRight animated">
                    <p class="about_us_p">I am a dedicated software engineer who has experience in dynamic development process. I have contributed to many open source projects. I worked at Samsung Electronics Ltd. and currently working at Polytec GmbH.</p>
                </div>
                <div class="col-md-4  wow fadeInRight animated">
                    <p class="about_us_p">I have a vision to create my own developed business components and eco systems to create systems with scalable features and greate life span. I have received many good complements from my works.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="work_title  wow fadeInUp animated">
                        <h1>Latest Works</h1>
                        <img src="/images/shape.png" alt="">
                        <p>Most of my latest works are open source projects. Some of them are business eco systems. Some web applications and sites are developed using Laravel framework, Blade templating and Google Polymers. Laravel and Blade templating together creates dynamic web applications which are generally user based systems, but if its cooked with Google Polymer then its become awesome and powerful. I have successfully created that recipes and blending of technologies to my future works. Let's see how the future is designed!</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 no_padding">
                    <div class="single_image">
                        ...
                        <div class="image_overlay">
                            <a href="">View Full Project</a>
                            <h2>Online Marketplace for Vendors</h2>
            ...
            <div class="row pad_top">
                ...
                <div class="col-md-4 no_padding">
                    <div class="single_image">
                        ...
                        <div class="image_overlay">
                            <a href="">View Full Project</a>
                            <h2>Crystal Market <br/> Coming soon ...</h2>
                            <h4>with Laravel and Google Polymer</h4>
                        </div>                        
                    </div>
                </div>
                <div class="col-md-4 no_padding">
                    <div class="single_image last_padding">
                        ...
                        <div class="image_overlay">
                            <a href="">View Full Project</a>
                            <h2>Crystal Dashboard <br/> Coming soon ...</h2>
                            <h4>with Laravel and Google Polymer</h4>
                        </div>                        
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-8 wow fadeInLeft animated">
                    <div class="left">
                        ...
                        <p>You can join my dev team forums or for saving valuable time to meet you can contact or drop your mail to our mailbox for consultancy. </p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="contact_title  wow fadeInUp animated">
                        <h1>get in touch</h1>
                        <img src="/images/shape.png" alt="">
                        <p>Future web solutions of business are designed here culturing new technologies. You can share your ideas or problems that you want overcome and need IT solutions you can keep me to your contact list.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-3  wow fadeInLeft animated">
                    ...
                    <div class="single_contact_info">
                        <h2>Email Me</h2>
                        <p>tajuddin.khandaker.cse.ju@gmail.com</p>
                    </div>
                    <div class="single_contact_info">
                        <h2>Address</h2>
                ...
                <div class="col-md-12 text-center   wow fadeInUp animated">
                    <div class="social">
                        ...
                        <ul class="icon_list">
                            ...
                            <li><a href="https://github.com/tajuddinkhandaker"><i class="fa fa-github"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
